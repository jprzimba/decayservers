...
COLOR_BLUE        = TEXTCOLOR_BLUE
COLOR_TEAL   = TEXTCOLOR_LIGHTBLUE
COLOR_LIGHTGREEN  = TEXTCOLOR_GREEN
COLOR_LIGHTGREY   = TEXTCOLOR_GREY
COLOR_DARKRED         = TEXTCOLOR_RED
COLOR_ORANGE      = TEXTCOLOR_ORANGE
COLOR_WHITE   = TEXTCOLOR_WHITE
COLOR_NONE = TEXTCOLOR_NONE

CONST_ANI_ENERGYBALL = CONST_ANI_ENERGY
...
WORLD_TYPE_NO_PVP = WORLDTYPE_NO_PVP
WORLD_TYPE_NOPVP = WORLDTYPE_NO_PVP
WORLD_TYPE_OPTIONAL = WORLDTYPE_NO_PVP
WORLDTYPE_OPTIONAL = WORLDTYPE_NO_PVP
WORLD_TYPE_PVP = WORLDTYPE_PVP
WORLD_TYPE_OPEN = WORLDTYPE_PVP
WORLD_TYPE_PVP_ENFORCED = WORLDTYPE_PVP_ENFORCED
WORLD_TYPE_HARDCORE = WORLDTYPE_PVP_ENFORCED
WORLDTYPE_HARDCORE = WORLDTYPE_PVP_ENFORCED

DATABASE_NONE = DATABASE_ENGINE_NONE
DATABASE_MYSQL = DATABASE_ENGINE_MYSQL
DATABASE_SQLITE = DATABASE_ENGINE_SQLITE

GAME_STATE_STARTUP = GAMESTATE_STARTUP
GAME_STATE_INIT = GAMESTATE_INIT
GAME_STATE_NORMAL = GAMESTATE_NORMAL
GAME_STATE_MAINTAIN = GAMESTATE_MAINTAIN
GAME_STATE_CLOSED = GAMESTATE_CLOSED
GAME_STATE_CLOSING = GAMESTATE_CLOSING
GAME_STATE_SHUTDOWN = GAMESTATE_SHUTDOWN
