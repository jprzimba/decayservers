...
if(isset($_REQUEST['town']) && isset($_REQUEST['owner']) && isset($_REQUEST['order']) && isset($_REQUEST['name']))
{
	...
	elseif($_REQUEST['name'] == 1)
	{
		$filterOwner = new SQL_Filter(new SQL_Field('name'), SQL_Filter::NOT_EQUAL, 0);
		$filter = new SQL_Filter($filterTown, SQL_Filter::CRITERIUM_AND, $filterOwner);
	}
	else
	{
