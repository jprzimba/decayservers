...
local node1 = keywordHandler:addKeyword({'yes'}, StdModule.say, {npcHandler = npcHandler, onlyFocus = true, text = 'What city do you wish to live in? Karmia or Enigma City'})
	local node2 = node1:addChildKeyword({'karmia'}, StdModule.say, {npcHandler = npcHandler, onlyFocus = true, town = 2, destination = {x=438, y=504, z=8}, text = 'Karmia, eh? So what vocation do you wish to become? sorcerer, druid, paladin or knight?'})
		...
		node3 = node2:addChildKeyword({'knight'}, StdModule.say, {npcHandler = npcHandler, vocation = 4, onlyFocus = true, text = 'A mighty warrior. Is that your final decision? This decision is irreversible!'})
			node3:addChildKeywordNode(yesNode)
			node3:addChildKeywordNode(noNode)
	node2 = node1:addChildKeyword({'enigma city', 'enigma'}, StdModule.say, {npcHandler = npcHandler, onlyFocus = true, town = 1, destination = {x=1000, y=1000, z=7}, text = 'Enigma City, eh? So what vocation do you wish to become? sorcerer, druid, paladin or knight?'})
