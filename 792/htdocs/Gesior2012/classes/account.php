...
class Account extends ObjectData
{
	...
	public $data = array('id' => null, 'password' => null,  'type' => null, 'premdays' => null, 'lastday' => null, 'key' => null, 'email' => null, 'blocked' => null, 'warnings' => null, 'email_new' => null, 'email_new_time' => null, 'rlname' => null, 'location' => null, 'page_access' => null, 'email_code' => null, 'next_email' => null, 'premium_points' => null, 'create_date' => null, 'create_ip' => null,  'last_post' => null, 'flag' => null);
	public static $fields = array('id', 'password', 'type', 'premdays', 'lastday',  'key', 'email', 'blocked', 'warnings', 'email_new', 'email_new_time', 'rlname', 'location', 'page_access', 'email_code', 'next_email', 'premium_points', 'create_date', 'create_ip', 'last_post', 'flag');
	public $players;
	public $playerRanks;
	public $guildAccess;
	public $bans;
